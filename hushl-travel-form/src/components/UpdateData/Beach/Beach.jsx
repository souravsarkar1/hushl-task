import { Box, Button, Center, Checkbox, CheckboxGroup, FormControl, FormLabel, Input, Radio, RadioGroup, Stack, Textarea, Wrap, WrapItem, useToast } from '@chakra-ui/react'
...
const BeachUpdate = ({ beach, id }) => {
    ...
    const [areoffBeachPatrolledbyLifeguardsData, setAreoffBeachPatrolledbyLifeguardsData] = useState(areoffBeachPatrolledbyLifeguards);
    const [lifeguardQualificationsData, setLifeguardQualificationsData] = useState([...lifeguardQualifications]);
    const [areSomePartsofTheBeachOnlyForPrivateUseData, setAreSomePartsofTheBeachOnlyForPrivateUseData] = useState(areSomePartsofTheBeachOnlyForPrivateUse);
    ...
    return (
        <Box>
            ...
            <FormControl>
                ...
                <Textarea
                    value={featuresData}
                    onChange={(e) => setFeaturesData(e.target.value)}
                    size="sm"
                    borderRadius="md"
                />
            ...
            <FormControl>
                ...
                <Textarea
                    value={tidesRipsData}
                    onChange={(e) => setTidesRipsData(e.target.value)}
                    size="sm"
                    borderRadius="md"
                />
            ...
            <FormControl>
                ...
                <CheckboxGroup
                    colorScheme="teal"
                    onChange={setLifeguardQualificationsData}
                    value={lifeguardQualificationsData}
                >
                    <Stack align="start">
            ...
            <FormControl>
                ...
                <RadioGroup onChange={(setAreSomePartsofTheBeachOnlyForPrivateUseData)} value={areSomePartsofTheBeachOnlyForPrivateUseData}>
                    <Stack direction="row">
                        <Radio value={"true"}>Yes</Radio>
                        <Radio value={"false"}>No</Radio>
                    </Stack>
            ...
            <Center><Button colorScheme='teal' onClick={hanldeSubmit}>Update Data</Button></Center>
        </Box>
    )
}
