  ...
  return (
    <Box w={'auto'}>
      <FormControl mb={4}>
        ...
        <Textarea placeholder="Enter state of repair" value={stateOfRepairData} onChange={handleStateOfRepairChange} />
      </FormControl>

      <FormControl mb={4}>
        <FormLabel>Scope of Renovation</FormLabel>
        <CheckboxGroup colorScheme="teal" value={scopeOfRenovationData} onChange={handleScopeOfRenovationChange}>
          <Wrap align="start">
            <WrapItem>
