  ...
  return (
    <>
      ...
      <FormControl>
        ...
        <RadioGroup
          onChange={value => handleInputChange('beach', 'areoffBeachPatrolledbyLifeguards', value)}
          value={formData.areoffBeachPatrolledbyLifeguards.toString()}
        >
          <Stack direction="row">
      ...
      <FormControl>
        ...
        <RadioGroup
          onChange={value => handleInputChange('beach', 'areSomePartsofTheBeachOnlyForPrivateUse', value)}
          value={formData.areSomePartsofTheBeachOnlyForPrivateUse.toString()}
        >
          <Stack direction="row">
            <Radio value={'true'}>Yes</Radio>
            <Radio value={'false'}>No</Radio>
      ...
      <FormControl>
        ...
        <RadioGroup
          onChange={value => handleInputChange('beach', 'willBeachVillasbeDisturbed', value)}
          value={formData.willBeachVillasbeDisturbed.toString()}
        >
          <Stack direction="row">
            <Radio value={'true'}>Yes</Radio>
            <Radio value={'false'}>No</Radio>
      ...
      <FormControl>
        <FormLabel>Cleaniness</FormLabel>
        <Input value={formData.cleanliness} onChange={e => handleInputChange('beach', 'cleanliness', e.target.value)} />
      </FormControl>
      <FormControl>
        <FormLabel>Include</FormLabel>
        <Input value={formData.include} onChange={e => handleInputChange('beach', 'include', e.target.value)} />
      </FormControl>
      <FormControl>
        <FormLabel>BBQSpots</FormLabel>
        <Input value={formData.BBQSpots} onChange={e => handleInputChange('beach', 'BBQSpots', e.target.value)} />
      </FormControl>
    </>
  );
};
